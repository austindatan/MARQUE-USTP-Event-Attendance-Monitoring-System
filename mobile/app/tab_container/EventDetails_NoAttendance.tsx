...
const GoingAvatarStack = () => {
  const avatars = [
    ...
    {
      id: 2,
      source: require("../../assets/images/neka_profile.jpg"),
      zIndex: 2,
    },
    {
      id: 3,
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoColumn}>
          <TouchableOpacity style={styles.infoBoxAttendance}>
            <Text style={styles.infoTextAtt}>
              Upload a photo of yourself at the event for verification. Make
              sure your face and surroundings of the venue are visible.
            </Text>
        ...
        <Text style={styles.aboutText}>
          ...
          {"\n"}We lead with heart, with purpose, with grit. City scholars man
          ta, pero mas labaw ana — we're movers, changemakers, voices for
          others.
          {"\n\n"}Let's discover the leader inside us through ISDA Pagsugpong
          2.0: Bake the Path Forward: Unleashing Leadership, Unlocked
          Potential.
          {"\n\n"}We're not just dreaming for ourselves — we're moving for
          something bigger.
        </Text>
        ...
        <Text style={styles.organizerDesc}>
          University City Scholars – USTP: An organization of trailblazing Iskolar sa Dakbayan across the USTP System.
        </Text>

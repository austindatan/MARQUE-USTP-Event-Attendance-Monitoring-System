...
const Header = ({ 
  ...
  const handleToggle = (tab: "Back" | "Incoming" | "Concluded" | "Officers") => {
    // Prevent switching to Officers tab if not allowed
    if (tab === "Officers" && !isOfficerTabAllowed) {
        console.warn("Access denied to Officers tab.");
        return; 
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Only show if isOfficerTabAllowed is true */}
        {isOfficerTabAllowed && (
            <TouchableOpacity

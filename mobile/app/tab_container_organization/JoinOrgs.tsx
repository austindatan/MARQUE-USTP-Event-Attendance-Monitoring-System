...
  // =======================
// Function now accepts the organization object directly from the card click
...
                  // 🛑 FIX 1: Call handleJoin directly with the organization object
...
      {/* JOIN REQUEST MODAL (Now acts purely as a success confirmation) */}
      <JoinModal
        visible={modalVisible}
        orgName={selectedOrg?.org_name}
        onClose={() => setModalVisible(false)}
        // 🛑 FIX 2: Remove the onJoin prop entirely, as the modal no longer confirms the action
      />
    </>
  );
};
